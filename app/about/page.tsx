...
const About: NextPage = () => {
  return (
    <div className="max-w-3xl mx-auto px-4 py-10 text-gray-800 dark:text-gray-200">
      <h1 className="text-3xl font-bold mb-6">About learncbse</h1>

      <p className="mb-4">
        Welcome to <strong>learncbse</strong>, your trusted platform for 
      ...
      <p className="mb-4">
        ...
        learncbse ensures that learning is easier, smarter, and more effective.
      </p>

      <p className="mt-6">
        🚀 With <strong>learncbse</strong>, you can learn faster, score better, 
